...
const NavigationFooter = () => {
  ...
  return (
    <section className="flex flex-col gap-y-6 border-b border-b-dark-brown p-6 text-center sm:border-t sm:border-b-0 sm:border-t-dark-brown md:w-full md:flex-row md:justify-evenly md:text-start">
