    ...
    <section className='flex flex-col items-center justify-center gap-y-4 border-b border-b-dark-brown p-6 dark:border-b-white-bone'>
      ...
      {isReviewShow && (
        ...
        >
          ...
          <Button className='w-1/2 py-2 text-sm duration-300 hover:bg-dark-brown hover:text-white-bone dark:border-white-bone dark:bg-dark-brown dark:text-white-bone dark:hover:bg-white-bone dark:hover:text-dark-brown'>
            Add Review
          </Button>
        </form>
      )}
