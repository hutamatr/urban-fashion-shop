...
const ModalCard = ({ children }) => {
  return (
    <section className='fixed bottom-0 left-0 right-0 z-30 mx-auto flex max-h-full max-w-lg flex-col overflow-y-scroll rounded-md bg-white-bone p-5 shadow sm:top-1/4 sm:max-h-fit'>
      {children}
    </section>
  );
};
